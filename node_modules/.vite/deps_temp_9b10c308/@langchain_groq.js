...
} from "./chunk-P3DOKP5C.js";
import "./chunk-LR3466M7.js";
import {
  ChatPromptValue,
  StringPromptValue
} from "./chunk-M2YZ6H3O.js";
import {
  AIMessage,
  AIMessageChunk,
  AsyncCaller,
...
function _convertDeltaToolCallToToolCallChunk(toolCalls, index) {
  ...
  return toolCalls.map((tc) => {
    ...
    return {
      ...
      args: (_b = tc.function) == null ? void 0 : _b.arguments,
      type: "tool_call_chunk",
      index
    };
  });
}
function _convertDeltaToMessageChunk(delta, index, xGroq) {
  const { role } = delta;
...
var ChatGroq = class extends BaseChatModel {
  ...
  async *_streamResponseChunks(messages, options, runManager) {
    ...
    for await (const data of response) {
      ...
      if ((_a2 = choice.delta) == null ? void 0 : _a2.role) {
